...
class Example(QWidget):
    def __init__(self):
        super().__init__()
        self.menu = {"ТУФЛИ ДЛЯ ТАНГО 39-43": 3590, "ТУФЛИ-ПЕРЧАТКИ 41": 7700, "ОКСФОРДЫ (все размеры)": 15300, "ДЕРБИ 38-43": 3444, "БРОГИ (все размеры)": 6800, "МОНКИ 37-39": 2230, "ЛОФЕРЫ 37-40": 7800, "ДЕЗЕРТЫ 39, 40": 9600, "ЧАККА 42": 3800}
        self.initUI()

    def initUI(self):
        self.setGeometry(500, 400, 400, 500)
        self.setWindowTitle('обувной интернет-магазин')
        ...
        self.setStyleSheet("background-color: # ffc014; color: #aaaa; font-family: Times;")
